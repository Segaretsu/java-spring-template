package co.com.jhonsebastianas.java.plantillawebServices.conf;
...
public class JerseyApplication extends ResourceConfig {
	...
	public JerseyApplication(ObjectMapper objectMapper) {
		packages("co.com.jhonsebastianas.java.plantillawebServices");
	...
	private void SwaggerConfig() {
		...
		swaggerConfigBean.setResourcePackage("co.com.jhonsebastianas.java.plantillawebServices.services");
